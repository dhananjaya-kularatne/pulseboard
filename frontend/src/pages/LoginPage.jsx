...
/**
 * Login page with a split layout: left panel shows branding/marketing content, right panel holds the actual login form. 
 * Matches the same layout pattern used on RegisterPage for visual consistency.
 */
    ...
    <div className="min-h-screen flex bg-slate-900">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center px-8">
        <div className="w-full max-w-sm">
          <h2 className="text-2xl font-bold text-white mb-6">Log in to PulseBoard</h2>
